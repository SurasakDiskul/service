          ...
          <div class="card bg-success">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase text-white font-weight-bold">KPIโดยรวมของแผนก</p>
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-dark shadow-dark text-center rounded-circle">
                    <i class="fa fa-bar-chart text-lg text-success opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card bg-danger">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-dark shadow-dark text-center rounded-circle">
                    <i class="fa fa-bar-chart text-lg text-danger opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card bg-success">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-dark shadow-dark text-center rounded-circle">
                    <i class="fa fa-user text-lg text-success opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card bg-danger">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-dark shadow-dark text-center rounded-circle">
                    <i class="fa fa-user text-lg text-danger opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
