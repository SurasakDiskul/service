    ...
    <div class="page-container">
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Structure Network</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">Home</a></li>
                                <li><span>Structure Network</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                ...
                <div class="row p-3">
        <div class="col-12">
            <iframe src="https://onedrive.live.com/embed?resid=4CFE575E9CE70B33%21629&authkey=!AKOVPsm5tFGEuDQ&em=2" width="100%" height="800" border="0" scrolling="no" frameborder="0" style = "border:0px;overflow:hidden;"></iframe>
        </div>
      </div>
        </div>
