    <?php
        ...
        //QUANTITY OF SERVICE
        $sql0= "SELECT * FROM tbnewwork";
        $result0 = mysqli_query($conn,$sql0);
        $row0 = mysqli_num_rows($result0);
        if($row0 != '0'){
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //KPI IT START
        $sqlit = "SELECT * FROM tbnewwork WHERE prostatus = 'Fully Complete'";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //KPI NEST START
        $sqlnest = "SELECT sum(employee1) FROM tbnewwork";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       //KPI AOOD START
       $sqlAOOD = "SELECT sum(employee2) FROM tbnewwork";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //KPI KHAN START
        $sqlKHAN = "SELECT sum(employee3) FROM tbnewwork";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //KPI PUK START
        $sqlPUK = "SELECT sum(employee4) FROM tbnewwork";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //KPI NB START
        $sqlNB = "SELECT sum(employee5) FROM tbnewwork";
        $resultNB = mysqli_query($conn,$sqlNB);
        $rowNB = mysqli_fetch_array($resultNB);
        $sumNB = $rowNB[0];
        if($sumNB != '0'){
        $KPINB2 = ($sumNB/$row0)*100;
