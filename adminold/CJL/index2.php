...
//<!-----------------------------------------------------0----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-01-01' AND '2023-01-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------1----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-02-01' AND '2023-02-28'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------2----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-03-01' AND '2023-03-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------3----------------------------------------------------->   
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-04-01' AND '2023-04-30'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------4----------------------------------------------------->   
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-05-01' AND '2023-01-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------5----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-06-01' AND '2023-06-30'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------6----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-07-01' AND '2023-07-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------7----------------------------------------------------->   
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-08-01' AND '2023-08-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------8----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-09-01' AND '2023-09-30'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------9----------------------------------------------------->    
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-10-01' AND '2023-10-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------10----------------------------------------------------->    
    ...
    WHERE 	`sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND startdate BETWEEN '2023-11-01' AND '2023-11-30'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
//<!-----------------------------------------------------11----------------------------------------------------->
    ...
    WHERE `sername`= 'Software (โปรแกรมในคอมพิวเตอร์)' AND	startdate BETWEEN '2023-12-01' AND '2023-12-31'AND serstatus = 'Fully Complete' AND `office` = 'CJL'";
...
Highcharts.chart('container', {
    ...
    title: {
        align: 'center',
        text: 'ยอดเงินรวมของการ SERVICE SOFTWARE (โปรแกรมในคอมพิวเตอร์) ของบริษัท CJL'
    },
    subtitle: {
        align: 'center',
