...
//<!-----------------------------------------------------0----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-01-01' AND '2023-01-31'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------1----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-02-01' AND '2023-02-28'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------2----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-03-01' AND '2023-03-31'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------3----------------------------------------------------->   
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-04-01' AND '2023-04-30'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------4----------------------------------------------------->   
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-05-01' AND '2023-05-31'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------5----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-06-01' AND '2023-06-30'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------6----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-07-01' AND '2023-07-31'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------7----------------------------------------------------->   
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-08-01' AND '2023-08-31'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------8----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-09-01' AND '2023-09-30'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------9----------------------------------------------------->    
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-10-01' AND '2023-10-31'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------10----------------------------------------------------->    
    ...
    WHERE 	`sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND startdate BETWEEN '2023-11-01' AND '2023-11-30'AND serstatus = 'Fully Complete'";
...
//<!-----------------------------------------------------11----------------------------------------------------->
    ...
    WHERE `sername`= 'โปรแกรมใช้งานภายในบริษัท (Coding)' AND	startdate BETWEEN '2023-12-01' AND '2023-12-31'AND serstatus = 'Fully Complete'";
...
Highcharts.chart('container', {
    ...
    title: {
        align: 'center',
        text: 'ยอดเงินรวมของการ SERVICE โปรแกรมใช้งานภายในบริษัท (Coding)'
    },
    subtitle: {
        align: 'center',
